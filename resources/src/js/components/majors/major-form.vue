<template>
	<transition name="flip" mode="out-in">
		...
		<div key="2" v-else >
			<form class="container-fluid csu-card__form" v-bind:id="'majorForm-' + form.cardIndex">
				<fieldset class="csu-card__form-sizing">
					<button v-show="selectedFormWasSubmittedOnce" class="btn btn-flip-card" @click="resetCurrentCard" > <i v class="fas fa fa-chevron-up"></i> <i v-show="windowSize > 500" v class="fas fa fa-chevron-left"></i> Change Major </button>
