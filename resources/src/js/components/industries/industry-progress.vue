<template>
    <div>
        ...
        <div v-for="(industry,index) in industriesByMajor" :key="index" class="row">
            <div v-if="industry.industryWage != null" class="col-12 industry-card__row">
                <div class="row">
                    <div class="col-3">{{industry.title}}</div>
                    <div class="col-9">
                        <div class="row">
                            <div class="col-10 industry-bar__padding">
            ...
            <div v-else-if="industry.industryWage === null && industry.percentage === null" class="col-12 industry-card__row noData">
                <div class="row">
                    <div class="col-3">{{industry.title}}</div>
                    <div class="col-9">
                        <div class="row">
        ...
        <div @click="toggleIndustryVisibility()" class="row industry-bar__collapse">
...
export default {
	methods: {
        ...
        toggleIndustryVisibility(){
            var targetNoData = document.querySelectorAll('.col-12.industry-card__row.noData');
