						...
						<div class="row no-gutters">
							...
							<span class="col">
								<p
									...
									@mouseover="toggleInfo('timeToDegree')"
									@mouseout="toggleInfo('timeToDegree')"
								>
									<i class="fa fa-info-circle"></i> Estimated Time to Completion of Degree
								</p>
							</span>
						</div>
						<div class="row my-3">
					...
					<div class="col-12 col-lg-11 col-xl-11 align-self-center">
						<div class="row no-gutters">
							<span class="col-12">
								...
								<p
									class="float-left pfre__chart-header font-weight-bold mb-0"
									@mouseout="toggleInfo('earnings')"
									@mouseover="toggleInfo('earnings')"
								>
					...
					<div class="col-12 col-lg-11 col-xl-11 align-self-center">
						<div class="row no-gutters">
							<div class="col-12">
								...
								<p
									class="float-left pfre__chart-header font-weight-bold mb-0"
									@mouseout="toggleInfo('return')"
									@mouseover="toggleInfo('return')"
								>
									<i class="fa fa-info-circle"></i> FRE - Financial Return on Education
								</p>
							</div>
						</div>
						<div class="row my-3">
