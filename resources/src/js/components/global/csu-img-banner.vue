<template>
    <div class="CSUImgBanner">
        <h2 class="CSUImgBanner__campusTitle"> {{ campusName }}</h2>
        <div class="CSUImgBanner__dataInfoWrapper">
            <h3 class="CSUImgBanner__dataTitle"> <span> {{ freTitle }} </span>  </h3>
            <p> {{ dummyCopy }} </p>
        </div>
    </div>
</template>
