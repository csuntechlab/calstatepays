...
class Channel_Islands_University_Majors_TableSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $json = File::get("database/data/universityMajorData/channel_islands_university_majors_table.json");
