...
class Dominguez_Hills_University_Majors_TableSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $json = File::get("database/data/universityMajorData/dominguez_hills_university_majors_table.json");
