...
class Investments_Template_Northridge_TableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        foreach ($industry_path as $row) {
            ...
            $investment->annual_earnings_id = $row->annual_earnings_during_school;
            $investment->annual_financial_aid_id = $row->annual_financial_aid;
            $investment->time_to_degree = $row->estimated_time_to_degree_years;
