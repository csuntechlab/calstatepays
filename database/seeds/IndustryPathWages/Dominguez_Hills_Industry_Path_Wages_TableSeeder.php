...
class Dominguez_Hills_Industry_Path_Wages_TableSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $json = File::get('database/data/industryPathWagesData/Industry_Path_Wages_dominguez_hills.json');
