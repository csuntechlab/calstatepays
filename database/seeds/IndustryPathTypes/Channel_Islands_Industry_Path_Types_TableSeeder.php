...
class Channel_Islands_Industry_Path_Types_TableSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $json = File::get('database/data/industryPathTypesData/Industry_Path_Types_channel_islands.json');
