...
earingsToId = {"$0":1,"$1 - $2,999":2,"$3,000 - $6,999":3,"$7,000 - $9,999":4, "$10000+":5}
df.annual_financial_aid_id = [earingsToId[item] for item in df.annual_financial_aid_id] 
...
# Ideally, age range id should be mapped to annual earnings id
df["age_range_id"] = df["annual_earnings_during_school_id"]
