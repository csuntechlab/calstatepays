...
class IndustryControllerTest extends TestCase
{
    ...
    public function test_Validator()
    {
      ...
      public function test_IndustryTestController(){
          $this->markTestSkipped('Will be revisited.');
